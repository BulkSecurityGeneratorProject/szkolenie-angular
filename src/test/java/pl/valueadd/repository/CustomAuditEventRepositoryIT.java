...
import pl.valueadd.config.audit.AuditEventConverter;
import pl.valueadd.domain.PersistentAuditEvent;
...
import static pl.valueadd.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
